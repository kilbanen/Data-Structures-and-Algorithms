...
public class BST<Key extends Comparable<Key>, Value> {
     ...
     * Explanation: The height function is recursively called for each node in the tree.
     *
    ...
    public Key median() {
      ...
      //fill in the correct implementation. The running time should be Theta(h), where h is the height of the tree.
      int median = (root.N + 1) / 2;
      return select(median-1);
    }
