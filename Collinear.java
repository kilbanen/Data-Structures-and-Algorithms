...
class Collinear
{
   ...
   // ----------------------------------------------------------
     ...
     *  You should adequately explain your answer. Answers without adequate explanation will not be counted.
     *
     *  Order of Growth: (N^2)lgN 
     *
     *  Explanation: Two linear for-loops, one logarithmic for-loop. 
     *
     *
     */
    static int countCollinearFast(int[] a1, int[] a2, int[] a3)
    {
		...
		for(int i = 0; i < a1.length; i++)
		{
			for(int j = 0; j < a2.length; j++)
			{
				if(binarySearch(a3, a1[i] * (2 - 3) + a2[j] * (3 - 1)))
				{
					count++;
				}
			}
     ...
     *  Order of Growth: lgN
     *
     *  Explanation: One logarithmic for-loop, each iteration checks half the number of inputs as the previous one.
     *
     */
