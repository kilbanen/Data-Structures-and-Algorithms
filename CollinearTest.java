...
public class CollinearTest
{
    ...
    /**
     * Check for no false positives in a double-element array
     */
    @Test
    public void testDoubleFalse()
    {
        int[] a3 = { 15, 5 };       int[] a2 = { 6, 7 };       int[] a1 = { 10, 15, 5 };
    ...
    {
        int[] a3 = { 15, 5 };       int[] a2 = { 5, 15 };       int[] a1 = { 10, 15, 5 };
	...
	/**
     * Check for no false positives in a triple-element array
     */
    @Test
    public void testTripleFalse()
    {
        int[] a3 = { 15, 5, 10 };       int[] a2 = { 6, 16, 11 };       int[] a1 = { 10, 15, 5 };
    ...
    {
        int[] a3 = { 15, 5, 10 };       int[] a2 = { 5, 15, 10 };       int[] a1 = { 10, 15, 5 };
